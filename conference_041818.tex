...
The graph is read in as an adjacency list. This is an edge representation of the graph where the 
...
\bibitem{b17} A. S. Tom et al., "Exploring optimizations on shared-memory platforms for parallel triangle counting algorithms," 2017 IEEE High Performance Extreme Computing Conference (HPEC), Waltham, MA, 2017, pp. 1-7.
\end{thebibliography}
\end{document}
